...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_M[] = {  // height, flip, rotate, expand
            ...
            { 0.9f, {365.0f, 1000.0f}, {82.0f, 120.0f}, {21.5f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.6f, {660.0f, 1000.0f}, {82.0f, 120.0f}, {-8.0f, 2.1f}, {600.0f, 18.0f} },
        ...
        RAM_D1_ATTR const arm_pose step_H[] = {
            ...
            { 1.35f, {720.0f, 1000.0f}, {88.0f, 120.0f}, {15.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.5f, {920.0f, 1000.0f}, {88.0f, 120.0f}, {-26.0f, 2.0f}, {800.0f, 18.0f} },
            { 0.3f, {570.0f, 1000.0f}, {-90.0f, 90.0f}, {0.0f, 4.8f}, {0.0f, 23.0f} },  // 加速处理
            { 0.1f }
        };
        // 吸取 -200 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.1f, {-240.0f, 1000.0f}, {56.5f, 120.0f}, {35.8f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 2.4f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {35.0f, 2.1f}, {700.0f, 18.0f} },
            { 0.25f, {570.0f, 1000.0f}, {-90.0f, 110.0f}, {0.0f, 3.4f}, {680.0f, 21.0f} },
            { 1.3f, {570.0f, 1000.0f}, {-90.0f, 110.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
