...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_P[] = {
            ...
            { 0.7f, {820.0f, 1000.0f}, {60.0f, 120.0f}, {25.0f, 2.1f}, {800.0f, 18.0f} },
            { 0.65f, {570.0f, 1000.0f}, {-90.0f, 110.0f}, {0.0f, 4.8f}, {0.0f, 22.0f} },
            { 0.1f }
        };
    }
    namespace place_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.1f, {80.0f, 1000.0f}, {-78.0f, 120.0f}, {-192.0f, 6.8f}, {790.0f, 21.0f}, FETCH_ },
            { 2.55f, {1040.0f, 1000.0f}, {-106.0f, 90.0f}, {-160.0f, 2.7f}, {710.0f, 21.0f} },
            { 1.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 1.1f, {1020.0f, 1000.0f}, {8.5f, 110.0f}, {-21.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
        // 取出KFS（存了2个）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            { 0.1f, {1040.0f, 1000.0f}, {-90.0f, 120.0f}, {0.0f, 3.1f}, {880.0f, 28.0f} },
            ...
            { 1.4f, {1020.0f, 1000.0f}, {8.5f, 110.0f}, {-21.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
        // 取出KFS（存了3个）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.1f, {1020.0f, 1000.0f}, {8.5f, 110.0f}, {-23.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
    }
    namespace place3_proceed {
        ...
        // 取出KFS（存了3个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.1f, {1020.0f, 1000.0f}, {18.5f, 110.0f}, {-33.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
    }
    // 释放KFS并回归默认姿态
    ...
    namespace load_kfs_proceed {
        ...
        // 将 KFS 存入（当前剩1个KFS）
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.1f, {880.0f, 1000.0f}, {-92.0f, 120.0f}, {-180.0f, 6.8f}, {429.5f, 18.0f} },
            { 1.65f, RELEASE_ },
