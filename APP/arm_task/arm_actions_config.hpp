...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_M[] = {  // height, flip, rotate, expand
            ...
            { 0.9f, {368.0f, 1000.0f}, {82.0f, 120.0f}, {17.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
        ...
        RAM_D1_ATTR const arm_pose step_H[] = {
            ...
            { 1.35, {720.0f, 1000.0f}, {88.0f, 120.0f}, {15.0f, 2.7f}, {1080.0f, 18.0f}, FETCH_ },
        ...
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.1f, {-220.0f, 1000.0f}, {65.0f, 120.0f}, {37.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 2.3f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {0.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.25f, {570.0f, 1000.0f}, {-90.0f, 110.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
