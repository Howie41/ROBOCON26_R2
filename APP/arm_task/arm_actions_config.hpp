...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.1f, {-240.0f, 1000.0f}, {56.5f, 120.0f}, {35.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 2.33f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {35.0f, 2.1f}, {700.0f, 18.0f} },
            { 0.25f, {570.0f, 1000.0f}, {-5.0f, 80.0f}, {0.0f, 3.4f}, {680.0f, 17.0f} },
            { 1.2f, {570.0f, 1000.0f}, {-90.0f, 70.0f}, {0.0f, 3.4f}, {0.0f, 17.0f} },
            { 0.1f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
    ...
    namespace place_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.1f, {1020.0f, 1000.0f}, {8.5f, 120.0f}, {-23.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
    }
