...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_M[] = {  // height, flip, rotate, expand
            ...
            { 0.44f, {660.0f, 1000.0f}, {82.0f, 120.0f}, {0.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.3, {570.0f, 1000.0f}, {-90.0f, 100.0f}, {0.0f, 2.8f}, {0.0f, 20.0f} },
            { 0.01f }
        };
        // 吸取 +400 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_H[] = {
            { 0.01f, {600.0f, 1000.0f}, {90.0f, 120.0f}, {-11.0f, 2.2f}, {1200.0f, 21.0f} },
            { 1.23f, {590.0f, 1000.0f}, {90.0f, 120.0f}, {3.0f, 2.1f}, {1200.0f, 18.0f}, FETCH_ },
            { 0.34f, {920.0f, 1000.0f}, {88.0f, 120.0f}, {-16.0f, 2.0f}, {800.0f, 18.0f} },
            { 0.48f, {570.0f, 1000.0f}, {-90.0f, 90.0f}, {0.0f, 2.8f}, {0.0f, 21.0f} },  // 加速处理
            { 0.01f }
        };
        // 吸取 -200 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.01f, {-240.0f, 1000.0f}, {56.5f, 120.0f}, {33.6f, 2.1f}, {1200.0f, 18.0f}, FETCH_ },
            { 2.38f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {33.6f, 2.1f}, {800.0f, 18.0f} },
            { 0.28f, {570.0f, 1000.0f}, {-5.0f, 40.0f}, {0.0f, 1.9f}, {730.0f, 17.0f} },
            { 1.2f, {570.0f, 1000.0f}, {-90.0f, 56.0f}, {0.0f, 2.0f}, {0.0f, 17.0f} },
            { 0.01f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_P[] = {
            { 0.01f, {500.0f, 1000.0f}, {50.0f, 120.0f}, {22.0f, 2.2f}, {1200.0f, 20.0f} },
            { 0.59f, {300.0f, 1000.0f}, {50.0f, 120.0f}, {44.0f, 2.1f}, {1200.0f, 18.0f}, FETCH_ },
            { 0.66f, {820.0f, 1000.0f}, {50.0f, 120.0f}, {44.0f, 2.0f}, {880.0f, 18.0f} },
            { 0.6f, {570.0f, 1000.0f}, {-90.0f, 80.0f}, {0.0f, 2.5f}, {0.0f, 20.0f} },
            { 0.01f }
        };
    }
    namespace place_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            ...
            { 2.45f, {1040.0f, 1000.0f}, {-106.0f, 90.0f}, {-160.0f, 2.7f}, {710.0f, 21.0f} },
            { 1.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 1.25f, {1020.0f, 1000.0f}, {6.0f, 90.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了2个）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            ...
            { 2.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 1.4f, {1020.0f, 1000.0f}, {6.0f, 90.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了3个）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {1020.0f, 1000.0f}, {6.5f, 120.0f}, {-22.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
    }
    namespace place3_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.01f, {80.0f, 1000.0f}, {-78.0f, 120.0f}, {-192.0f, 6.8f}, {790.0f, 21.0f}, FETCH_ },
            { 2.45f, {1040.0f, 1000.0f}, {-106.0f, 90.0f}, {-160.0f, 2.7f}, {710.0f, 21.0f} },
            { 1.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 1.1f, {1020.0f, 1000.0f}, {17.5f, 110.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了2个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            { 0.01f, {1040.0f, 1000.0f}, {-90.0f, 120.0f}, {0.0f, 3.1f}, {880.0f, 28.0f} },
            { 0.7f, {900.0f, 1000.0f}, {-88.0f, 120.0f}, {-200.0f, 6.8f}, {720.0f, 28.0f}, FETCH_ },
            { 2.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 1.4f, {1020.0f, 1000.0f}, {17.5f, 110.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了3个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {1020.0f, 1000.0f}, {18.0f, 110.0f}, {-33.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
    }
    // 释放KFS并回归默认姿态
    ...
    namespace drop_kfs_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_12[] = {
            { 0.01f, {720.0f, 1000.0f}, {0.0f, 120.0f}, {-150.0f, 6.8f}, {1200.0f, 18.0f} },
            { 0.95f, RELEASE_ },
            { 0.1f, RESET_ },
            { 0.01f }
        };
        // 将 KFS 丢掉（当前剩3个KFS）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {720.0f, 1000.0f}, {-60.0f, 120.0f}, {0.0f, 6.8f}, {1200.0f, 18.0f} },
            { 0.5f, {720.0f, 1000.0f}, {-60.0f, 120.0f}, {-150.0f, 6.8f}, {1200.0f, 18.0f} },
            { 0.95f, RELEASE_ },
            { 0.38f, {720.0f, 1000.0f}, {-60.0f, 120.0f}, {0.0f, 6.8f}, {1200.0f, 18.0f} },
            { 1.0f, RESET_ },
            { 0.01f }
        };
    }
