...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_P[] = {
            { 0.01f, {500.0f, 1000.0f}, {50.0f, 120.0f}, {22.0f, 2.2f}, {1170.0f, 20.0f} },
            { 0.6f, {300.0f, 1000.0f}, {50.0f, 120.0f}, {40.0f, 2.1f}, {1170.0f, 18.0f}, FETCH_ },
            { 0.7f, {920.0f, 1000.0f}, {50.0f, 80.0f}, {22.0f, 2.0f}, {880.0f, 18.0f} },
            { 0.9f, {570.0f, 1000.0f}, {-90.0f, 70.0f}, {0.0f, 2.2f}, {0.0f, 18.0f} },
            { 0.01f }
        };
    }
    ...
    namespace place3_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.01f, {80.0f, 1000.0f}, {-78.0f, 120.0f}, {-192.0f, 6.8f}, {790.0f, 21.0f}, FETCH_ },
            { 2.45f, {1040.0f, 1000.0f}, {-106.0f, 90.0f}, {-160.0f, 2.7f}, {710.0f, 21.0f} },
            { 1.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-28.7f, 3.1f}, {660.0f, 18.0f} },
            { 1.1f, {1020.0f, 1000.0f}, {15.0f, 110.0f}, {-28.7f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了2个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            { 0.01f, {1040.0f, 1000.0f}, {-90.0f, 120.0f}, {0.0f, 3.1f}, {880.0f, 28.0f} },
            { 0.7f, {900.0f, 1000.0f}, {-88.0f, 120.0f}, {-200.0f, 6.8f}, {720.0f, 28.0f}, FETCH_ },
            { 2.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-28.7f, 3.1f}, {660.0f, 18.0f} },
            { 1.4f, {1020.0f, 1000.0f}, {15.0f, 110.0f}, {-28.7f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了3个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {1020.0f, 1000.0f}, {15.4f, 110.0f}, {-28.7f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
    }
    // 释放KFS并回归默认姿态
