...
namespace arm_actions_config {
    RAM_D1_ATTR const arm_pose start_proceed[] = {  // 启动姿态
        { 0.1f, {570.0f, 1000.0f}, {90.0f, 120.0f}, {-85.0f, 2.3f}, {630.0f, 20.0f} },
        { 0.75f, {600.0f, 1000.0f}, {0.0f, 120.0f}, {0.0f, 2.3f}, {560.0f, 20.0f} },
        { 0.8f, RESET_ },
        { 0.1f }
    };
    // 复位姿态
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_M[] = {  // height, flip, rotate, expand
            { 0.1f, {520.0f, 1000.0f}, {82.0f, 120.0f}, {4.0f, 2.2f}, {1080.0f, 20.0f} },
            { 0.9f, {400.0f, 1000.0f}, {82.0f, 120.0f}, {15.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.55f, {660.0f, 1000.0f}, {82.0f, 120.0f}, {-8.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.3, {570.0f, 1000.0f}, {-90.0f, 100.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +400 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_H[] = {
            { 0.1f, {780.0f, 1000.0f}, {90.0f, 120.0f}, {-9.0f, 2.2f}, {1080.0f, 20.0f} },
            { 1.35, {740.0f, 1000.0f}, {88.0f, 120.0f}, {14.0f, 2.7f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.5f, {920.0f, 1000.0f}, {96.0f, 120.0f}, {-20.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.3f, {570.0f, 1000.0f}, {-90.0f, 120.0f}, {0.0f, 4.8f}, {0.0f, 23.0f} },  // 加速处理
            { 0.1f }
        };
        // 吸取 -200 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.1f, {-200.0f, 1000.0f}, {67.0f, 120.0f}, {33.5f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 2.25f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {0.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.25f, {570.0f, 1000.0f}, {-90.0f, 100.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_P[] = {
            { 0.1f, {500.0f, 1000.0f}, {50.0f, 120.0f}, {22.0f, 2.2f}, {1080.0f, 20.0f} },
            { 0.8f, {300.0f, 1000.0f}, {50.0f, 120.0f}, {44.0f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.68f, {820.0f, 1000.0f}, {60.0f, 120.0f}, {25.0f, 2.1f}, {800.0f, 18.0f} },
            { 0.6f, {570.0f, 1000.0f}, {-90.0f, 100.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
    }
    namespace place_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.1f, {90.0f, 1000.0f}, {-78.0f, 120.0f}, {-192.0f, 6.8f}, {800.0f, 21.0f}, FETCH_ },
            { 2.6f, {1040.0f, 1000.0f}, {-106.0f, 90.0f}, {-160.0f, 2.7f}, {700.0f, 21.0f} },
            { 1.2f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 1.1f, {1020.0f, 1000.0f}, {8.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
        // 取出KFS（存了2个）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            { 0.1f, {1040.0f, 1000.0f}, {-90.0f, 120.0f}, {0.0f, 3.1f}, {810.0f, 28.0f} },
            { 0.7f, {940.0f, 1000.0f}, {-74.0f, 120.0f}, {-200.0f, 6.8f}, {680.0f, 28.0f}, FETCH_ },
            { 2.6f, {1020.0f, 1000.0f}, {-81.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 1.4f, {1020.0f, 1000.0f}, {8.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
        // 取出KFS（存了3个）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.1f, {1020.0f, 1000.0f}, {8.5f, 100.0f}, {-18.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.1f }
        };
    }
    // 释放KFS并回归默认姿态
    ...
    namespace load_kfs_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_0[] = {
            { 0.1f, {680.0f, 1000.0f}, {-90.0f, 120.0f}, {-180.0f, 6.8f}, {460.0f, 18.0f} },
        ...
        // 将 KFS 存入（当前剩1个KFS）
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            { 0.1f, {680.0f, 1000.0f}, {-90.0f, 120.0f}, {-180.0f, 6.8f}, {420.0f, 18.0f} },
            { 1.7f, RELEASE_ },
