...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_L[] = {
            { 0.01f, {-240.0f, 1000.0f}, {56.5f, 120.0f}, {35.0f, 2.1f}, {1200.0f, 18.0f}, FETCH_ },
            { 2.4f, {660.0f, 1000.0f}, {80.0f, 120.0f}, {35.0f, 2.1f}, {700.0f, 18.0f} },
    ...
    namespace place_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            ...
            { 1.25f, {1020.0f, 1000.0f}, {9.0f, 90.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了2个）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            ...
            { 1.4f, {1020.0f, 1000.0f}, {9.0f, 90.0f}, {-19.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了3个）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {1020.0f, 1000.0f}, {12.0f, 120.0f}, {-22.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
    }
    namespace place3_proceed {
        ...
        RAM_D1_ATTR const arm_pose kfs_1[] = {
            ...
            { 1.1f, {1020.0f, 1000.0f}, {21.0f, 110.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了2个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_2[] = {
            ...
            { 1.4f, {1020.0f, 1000.0f}, {21.0f, 110.0f}, {-31.0f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
        // 取出KFS（存了3个）（放置第三层）
        RAM_D1_ATTR const arm_pose kfs_3[] = {
            { 0.01f, {1020.0f, 1000.0f}, {23.5f, 110.0f}, {-33.5f, 3.1f}, {660.0f, 18.0f} },
            { 0.01f }
        };
    }
    // 释放KFS并回归默认姿态
