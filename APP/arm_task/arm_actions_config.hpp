...
namespace arm_actions_config {
    ...
    namespace fetch_proceed {
        ...
        RAM_D1_ATTR const arm_pose step_M[] = {  // height, flip, rotate, expand
            ...
            { 0.8f, {365.0f, 1000.0f}, {82.0f, 120.0f}, {21.5f, 2.1f}, {1080.0f, 18.0f}, FETCH_ },
            { 0.5f, {660.0f, 1000.0f}, {82.0f, 120.0f}, {-8.0f, 2.1f}, {600.0f, 18.0f} },
            { 0.3, {570.0f, 1000.0f}, {-90.0f, 100.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +400 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_H[] = {
            { 0.1f, {600.0f, 1000.0f}, {90.0f, 120.0f}, {-8.0f, 2.2f}, {1170.0f, 21.0f} },
            { 1.2f, {590.0f, 1000.0f}, {90.0f, 120.0f}, {3.0f, 2.1f}, {1170.0f, 18.0f}, FETCH_ },
            { 0.4f, {920.0f, 1000.0f}, {88.0f, 120.0f}, {-8.0f, 2.0f}, {800.0f, 18.0f} },
            { 0.3f, {570.0f, 1000.0f}, {-90.0f, 90.0f}, {0.0f, 3.4f}, {0.0f, 23.0f} },  // 加速处理
            { 0.1f }
        };
        // 吸取 -200 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_L[] = {
            ...
            { 0.25f, {570.0f, 1000.0f}, {-5.0f, 80.0f}, {0.0f, 3.4f}, {680.0f, 21.0f} },
            { 1.3f, {570.0f, 1000.0f}, {-90.0f, 90.0f}, {0.0f, 3.4f}, {0.0f, 21.0f} },
            { 0.1f }
        };
        // 吸取 +0 台阶 KFS（存了0个）
        RAM_D1_ATTR const arm_pose step_P[] = {
            ...
            { 0.65f, {570.0f, 1000.0f}, {-90.0f, 110.0f}, {0.0f, 3.4f}, {0.0f, 22.0f} },
            { 0.1f }
        };
    }
