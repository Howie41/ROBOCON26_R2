...
public:
    ...
    void setRotate(float pos, float speed) { arm_rotate_.posWithSpeedControl(-pos - 85.0f, 0.2f * speed); }
    void setExpand(float pos, float speed) { arm_expand_.posWithSpeedControl(std::clamp(pos, 30.0f, 1080.0f), 2.1f * speed); }
