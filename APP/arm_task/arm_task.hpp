...
public:
    ...
    void setExpand(float pos, float speed, float ini_buffer_pos, float end_buffer_pos) { arm_expand_.posWithSpeedControl(-std::clamp(pos, 30.0f, 1050.0f), 0.86 * speed, ini_buffer_pos, end_buffer_pos, 0.0f, 0.0f); }
